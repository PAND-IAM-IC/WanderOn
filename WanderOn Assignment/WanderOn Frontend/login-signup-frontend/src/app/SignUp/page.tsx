...
import apiClient from "../../utils/axiosSetup"; // Import your axios setup
...
const LoginSignUpPage = () => {
  ...
  return (
    <div className="flex min-h-[95vh] bg-green-700">
      <div className="flex-1 flex flex-col justify-center items-center p-8">
        <img
          src="https://cdn.pixabay.com/photo/2017/04/05/01/15/vintage-2203715_1280.jpg"
          alt="Descriptive Alt Text"
          className="w-full h-auto mb-4 rounded"
          style={{ maxHeight: "80vh", objectFit: "cover" }}
        />
        <p className="text-white text-center text-lg">WanderOn Limitlessly</p>
      </div>
